...
//
//		 CallToolResult getSystemInfoResult = client.callTool(new CallToolRequest("getSystemInfo", new HashMap<>()));
//		 System.out.println(">>>>>>> getSystemInfo = " + getSystemInfoResult);
//
//
//        CallToolResult addNumbersResult = client.callTool(new CallToolRequest("addNumbers",
